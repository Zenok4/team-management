...
const ChapterContent = ({
  ...
  const chapterTasks = tasks.filter((t) => t.chapters.$id === chapter.$id);
              ...
              <CardContent className="space-y-4">
                {roles.map((role) => {
                  ...
                  return (
                    <div
                      key={role.$id}
                      className="flex justify-between p-4 border rounded-lg hover:bg-primary/10 transition-colors"
